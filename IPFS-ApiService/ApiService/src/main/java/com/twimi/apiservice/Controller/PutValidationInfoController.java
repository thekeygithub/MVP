...
@WebServlet(urlPatterns = {"/api/putUserInformation"})
public class PutValidationInfoController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            //存储
            returnAddResult = userDataService.addUploadDataByJson(requestData);
        } catch (Exception e) {
            e.printStackTrace();
        }
