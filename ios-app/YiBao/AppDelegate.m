...
//    BrushFacePayViewController *log = [[BrushFacePayViewController alloc] init];

//    FaceStreamDetectorViewController *log = [[FaceStreamDetectorViewController alloc] init];
    UINavigationController *navigationvc = [[UINavigationController alloc] initWithRootViewController:log];
