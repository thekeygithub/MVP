...
<script type="text/javascript">
	...
	var url = "<%=basePath%>pageFunction/searchtraInfo";
...
<body style="margin:0px 10%;">
	...
	<div>
		<div class="header" style="padding:0px;">
			<div class="qukuaitit"><spring:message code="transactionInfo"></spring:message></div>
		...
		<div class="content clearfix" style="padding:10px 0px;">
			<div style="padding:10px 0px;" class="clearfix">
				<div class="zhuanru">
					<div class="scriptboxtop"><spring:message code="sentFrom"></spring:message></div>
					<div id="sender_addr1"></div>
					<div id="sender_addr2"></div>
				</div>
				<div class="fuhao">></div>
				<div class="zhuanchu">
					<div class="scriptboxtop"><spring:message code="sentTo"></spring:message></div>
					<div id="receiver_addr1"></div>
					<div id="receiver_addr2"></div>
				</div>
			</div>
			<div class="scriptbox">
