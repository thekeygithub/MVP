...
var organizationTreeId='deptTree';
...
function OrgNode(){
	...
	this.inIt= function(){
		...
		document.getElementById(organizationTreeId).appendChild(tempDiv);
		...
		this.Box=document.getElementById(this.Id);//$(this.Id);
...
function OrgShow(OrgNode_){
	...
	function CreateLine(type_, top_, left_, long_, size_, color_, id_){
		...
		document.getElementById(organizationTreeId).appendChild(this.Line);
